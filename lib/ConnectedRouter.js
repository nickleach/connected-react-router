    ...
    function ConnectedRouter(props) {
      ...
      _this.unsubscribe = store.subscribe(function () {
        ...
        var _getLocation = getLocation(store.getState()),
            ...
            keyInStore = _getLocation.key; // Extract history's location
        ...
        var _history$location = history.location,
            ...
            keyInHistory = _history$location.key; // If we do time travelling, the location in store is changed but location in history is not changed

        if (pathnameInHistory !== pathnameInStore || searchInHistory !== searchInStore || hashInHistory !== hashInStore || stateInStore !== stateInHistory || keyInStore !== keyInHistory) {
